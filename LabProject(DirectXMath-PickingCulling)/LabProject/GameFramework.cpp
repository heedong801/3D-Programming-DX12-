...
void CGameFramework::ClearFrameBuffer(DWORD dwColor)
{
	...
	::Rectangle(m_hDCFrameBuffer, m_pPlayer->m_pCamera->m_d3dViewport.TopLeftX, m_pPlayer->m_pCamera->m_d3dViewport.TopLeftY, m_pPlayer->m_pCamera->m_d3dViewport.Width, m_pPlayer->m_pCamera->m_d3dViewport.Height);
...
{    
    HDC hDC = ::GetDC(m_hWnd);
    ::BitBlt(hDC, m_pPlayer->m_pCamera->m_d3dViewport.TopLeftX, m_pPlayer->m_pCamera->m_d3dViewport.TopLeftY, m_pPlayer->m_pCamera->m_d3dViewport.Width, m_pPlayer->m_pCamera->m_d3dViewport.Height, m_hDCFrameBuffer, m_pPlayer->m_pCamera->m_d3dViewport.TopLeftX, m_pPlayer->m_pCamera->m_d3dViewport.TopLeftY, SRCCOPY);
    ::ReleaseDC(m_hWnd, hDC);
}
